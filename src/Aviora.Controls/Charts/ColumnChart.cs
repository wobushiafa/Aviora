...
/// <summary>
/// Displays a reusable single-series column chart. Use <see cref="Values"/> for
/// simple numeric sequences or <see cref="ItemsSource"/> for rich data points.
/// </summary>
public class ColumnChart : Control
{
    public static readonly StyledProperty<IEnumerable<double>?> ValuesProperty =
        AvaloniaProperty.Register<ColumnChart, IEnumerable<double>?>(nameof(Values));
    public static readonly StyledProperty<IEnumerable<IChartDataPoint>?> ItemsSourceProperty =
        AvaloniaProperty.Register<ColumnChart, IEnumerable<IChartDataPoint>?>(nameof(ItemsSource));
    public static readonly StyledProperty<double> MinValueProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(MinValue));
    public static readonly StyledProperty<double> MaxValueProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(MaxValue), 100.0);
    public static readonly StyledProperty<bool> AutoRangeProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(AutoRange));
    public static readonly StyledProperty<double> AutoRangePaddingRatioProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(AutoRangePaddingRatio), 0.08);
    ...
    public static readonly StyledProperty<IBrush> GridLineBrushProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(GridLineBrush), Brushes.LightGray);
    public static readonly StyledProperty<bool> ShowGridLinesProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowGridLines), true);
    public static readonly StyledProperty<bool> ShowThresholdsProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowThresholds));
    public static readonly StyledProperty<IEnumerable<ChartThreshold>?> ThresholdsProperty =
        AvaloniaProperty.Register<ColumnChart, IEnumerable<ChartThreshold>?>(nameof(Thresholds));
    public static readonly StyledProperty<ThresholdDirection> ThresholdDirectionProperty =
        AvaloniaProperty.Register<ColumnChart, ThresholdDirection>(
    ...
    public static readonly StyledProperty<bool> ShowThresholdLabelsProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowThresholdLabels), true);
    public static readonly StyledProperty<double> ThresholdLabelFontSizeProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(ThresholdLabelFontSize), 10.0);
    public static readonly StyledProperty<bool> ShowXAxisProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowXAxis), true);
    public static readonly StyledProperty<string?> XAxisLabelsProperty =
        AvaloniaProperty.Register<ColumnChart, string?>(nameof(XAxisLabels));
    public static readonly StyledProperty<IEnumerable<string>?> XAxisLabelsSourceProperty =
        AvaloniaProperty.Register<ColumnChart, IEnumerable<string>?>(nameof(XAxisLabelsSource));
    public static readonly StyledProperty<ChartLabelMode> XAxisLabelModeProperty =
        AvaloniaProperty.Register<ColumnChart, ChartLabelMode>(nameof(XAxisLabelMode), ChartLabelMode.Auto);
    public static readonly StyledProperty<int> XAxisLabelIntervalProperty =
        AvaloniaProperty.Register<ColumnChart, int>(nameof(XAxisLabelInterval), 1);
    public static readonly StyledProperty<IBrush> XAxisTextBrushProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(XAxisTextBrush), Brushes.Gray);
    public static readonly StyledProperty<double> XAxisFontSizeProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(XAxisFontSize), 10.0);
    public static readonly StyledProperty<double> XAxisHeightProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(XAxisHeight), 26.0);
    public static readonly StyledProperty<bool> ShowYAxisProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowYAxis), true);
    public static readonly StyledProperty<int> GridLineCountProperty =
        AvaloniaProperty.Register<ColumnChart, int>(nameof(GridLineCount), 5);
    public static readonly StyledProperty<string?> YAxisLabelsProperty =
        AvaloniaProperty.Register<ColumnChart, string?>(nameof(YAxisLabels));
    public static readonly StyledProperty<IEnumerable<string>?> YAxisLabelsSourceProperty =
        AvaloniaProperty.Register<ColumnChart, IEnumerable<string>?>(nameof(YAxisLabelsSource));
    public static readonly StyledProperty<double> YAxisWidthProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(YAxisWidth), 44.0);
    public static readonly StyledProperty<double> YAxisFontSizeProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(YAxisFontSize), 10.0);
    public static readonly StyledProperty<IBrush> YAxisTextBrushProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(YAxisTextBrush), Brushes.Gray);
    public static readonly StyledProperty<bool> IsAnimationEnabledProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(IsAnimationEnabled), true);
    public static readonly StyledProperty<TimeSpan> AnimationDurationProperty =
        AvaloniaProperty.Register<ColumnChart, TimeSpan>(nameof(AnimationDuration), TimeSpan.FromMilliseconds(320));
    public static readonly StyledProperty<int> AnimationItemLimitProperty =
        AvaloniaProperty.Register<ColumnChart, int>(nameof(AnimationItemLimit), 200);
    public static readonly StyledProperty<TimeSpan> UpdateThrottleIntervalProperty =
        AvaloniaProperty.Register<ColumnChart, TimeSpan>(nameof(UpdateThrottleInterval), TimeSpan.FromMilliseconds(400));
    public static readonly StyledProperty<bool> ShowEmptyTextProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(ShowEmptyText), true);
    public static readonly StyledProperty<string> EmptyTextProperty =
        AvaloniaProperty.Register<ColumnChart, string>(nameof(EmptyText), "No data");
    public static readonly StyledProperty<IBrush> EmptyTextBrushProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(EmptyTextBrush), Brushes.Gray);
    public static readonly StyledProperty<double> EmptyTextFontSizeProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(EmptyTextFontSize), 12.0);
    public static readonly StyledProperty<int> SelectedIndexProperty =
        AvaloniaProperty.Register<ColumnChart, int>(nameof(SelectedIndex), -1, defaultBindingMode: BindingMode.TwoWay);
    public static readonly StyledProperty<IChartDataPoint?> SelectedItemProperty =
        AvaloniaProperty.Register<ColumnChart, IChartDataPoint?>(nameof(SelectedItem), defaultBindingMode: BindingMode.TwoWay);
    public static readonly StyledProperty<ICommand?> ItemClickCommandProperty =
        AvaloniaProperty.Register<ColumnChart, ICommand?>(nameof(ItemClickCommand));
    ...
    public static readonly StyledProperty<bool> IsToolTipEnabledProperty =
        AvaloniaProperty.Register<ColumnChart, bool>(nameof(IsToolTipEnabled), true);
    public static readonly StyledProperty<IBrush> ToolTipBackgroundProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(ToolTipBackground), new SolidColorBrush(Color.FromArgb(235, 32, 38, 46)));
    public static readonly StyledProperty<IBrush> ToolTipTextBrushProperty =
        AvaloniaProperty.Register<ColumnChart, IBrush>(nameof(ToolTipTextBrush), Brushes.White);
    public static readonly StyledProperty<double> ToolTipFontSizeProperty =
        AvaloniaProperty.Register<ColumnChart, double>(nameof(ToolTipFontSize), 11.0);
    public static readonly StyledProperty<Func<double, string>?> YAxisLabelFormatterProperty =
        AvaloniaProperty.Register<ColumnChart, Func<double, string>?>(nameof(YAxisLabelFormatter));
    public static readonly StyledProperty<Func<IChartDataPoint, string>?> ToolTipFormatterProperty =
        AvaloniaProperty.Register<ColumnChart, Func<IChartDataPoint, string>?>(nameof(ToolTipFormatter));
    ...
    static ColumnChart()
    {
        AffectsRender<ColumnChart>(
            ...
            AutoRangeProperty, AutoRangePaddingRatioProperty, BarWidthRatioProperty,
            ColumnBackgroundBrushProperty, DefaultBrushProperty,
            GridLineBrushProperty, ShowGridLinesProperty, ShowThresholdsProperty, ThresholdsProperty,
            ThresholdDirectionProperty, ShowThresholdLabelsProperty, ThresholdLabelFontSizeProperty,
            ShowXAxisProperty, XAxisLabelsProperty,
            XAxisLabelsSourceProperty, XAxisLabelModeProperty, XAxisLabelIntervalProperty, XAxisTextBrushProperty,
            XAxisFontSizeProperty, XAxisHeightProperty, ShowYAxisProperty, GridLineCountProperty,
            YAxisLabelsProperty, YAxisLabelsSourceProperty, YAxisWidthProperty, YAxisFontSizeProperty,
            YAxisTextBrushProperty, ShowEmptyTextProperty, EmptyTextProperty, EmptyTextBrushProperty,
            EmptyTextFontSizeProperty, SelectedIndexProperty, SelectedItemProperty, SelectedBarBrushProperty,
            SelectionOverlayBrushProperty, SelectionStrokeBrushProperty, SelectionStrokeThicknessProperty,
            IsToolTipEnabledProperty, ToolTipBackgroundProperty,
    ...
    protected override void OnPointerMoved(PointerEventArgs e)
    {
        ...
        int index = HitTestItem(_pointerPosition);
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        int index = HitTestItem(e.GetPosition(this));
    ...
    private void OnObservedCollectionChanged(object? sender)
    {
        ...
        {
            Dispatcher.UIThread.Post(affectsOnlyRendering ? InvalidateVisual : HandleNewData);
            return;
        }
    ...
    private void HandleNewData()
    {
        ...
        _updateScheduler.Schedule(BuildItems(), UpdateThrottleInterval);
    }

    private List<IChartDataPoint> BuildItems()
    {
        return ChartDataPipeline.BuildItems(ItemsSource, Values, XAxisLabelsSource, XAxisLabels);
    }
    ...
    {
        if (!_animation.IsAnimating || _animationFrameRequested || TopLevel.GetTopLevel(this) == null)
        {
            return;
        }
    ...
    private void OnAnimationFrame(TimeSpan elapsed)
    {
        ...
        double progress = Math.Clamp((elapsed - _animationStartTime.Value).TotalMilliseconds /
                                     Math.Max(1, AnimationDuration.TotalMilliseconds), 0, 1);
    ...
    {
        return _renderer.HitTest(this, _items, point);
    }
